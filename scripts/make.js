...
const HBUILDERX_PLUGINS_PATHES_DIR = process.env.HBUILDERX_PLUGINS_PATHES_DIR
...
const pathDir = path.relative(cwd, path.join(HBUILDERX_PLUGINS_PATHES_DIR, pluginName))
